...
export const streamCourseAdvice = async (
  ...
  // Initialize with the safe key using the new SDK
  ...
  try {
    ...
    // Use gemini-2.5-flash as recommended for basic text tasks
        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    {
                        text: 'Extract and refine this signature. Output ONLY the signature in solid black ink on a pure white background. Remove all noise, paper texture, grid lines, shadows, and artifacts. The result should be a clean, high-contrast signature suitable for a professional certificate.'
                    }
                ]
            }
        });
